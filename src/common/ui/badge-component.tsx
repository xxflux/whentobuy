...
const badgeVariants = cva(
    'flex items-center whitespace-nowrap gap-1.5 rounded-sm px-2 py-0.5 text-[0.7rem] font-medium transition-colors',
    {
        variants: {
            variant: {
                default: 'bg-surface text-foreground rounded-md',
                secondary: 'bg-surface text-surface-foreground rounded-full',
                surface: 'bg-primary text-primary-foreground rounded-full',

...
import { Dialog, DialogContent, DialogOverlay } from './dialog-component';
...
>(({ className, ...props }, ref) => (
    <CommandPrimitive.Item
        ref={ref}
        className={cn(
            'text-foreground aria-selected:bg-surface aria-selected:text-surface-foreground relative flex min-h-8 cursor-pointer items-center gap-2 rounded-lg !px-3 !py-2 text-xs font-medium outline-none aria-disabled:pointer-events-none aria-disabled:opacity-50 md:text-sm',
            className
        )}
        {...props}
    />
